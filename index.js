(() => {
  ...
  const ES = {
    ...
    "order.subtitle": "Usa los enlaces de envío para bolsas o K-Cups, o usa el perfil de pedidos para recogida y entrega local.",
    ...
    "order.note.body": "Usa los enlaces de envío para bolsas de café o K-Cups, y usa el perfil de pedidos para recogida o entrega. Si prefieres hacerlo de forma más personal o quieres ayuda para completar la orden, mándanos un texto.",
    ...
    "faq.q1": "¿Cómo ordeno?",
    "faq.a1": "Usa el perfil de pedidos local para recogida o entrega, y usa los enlaces de envío para bolsas de café o K-Cups.",
