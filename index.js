(() => {
  ...
  const T = {
    en: {
      ...
      "hero.note": "Free pickup is available in Beardstown and Springfield. Beardstown delivery is free. Springfield delivery may incur a fee. For pickup or local delivery, text or email us for details.",
      "hero.compliance": "Online checkout is for Illinois shipping orders only. For pickup or local delivery, please text or email us instead.",
      "cta.buy": "Order Shipping",
      ...
      "faq.a2": "Use online checkout only for Illinois shipping orders. For free pickup in Beardstown or Springfield, or for local delivery, order directly by email or by text. Beardstown delivery is free. Springfield delivery may incur a fee depending on the order and distance.",
      "faq.q3": "Do you ship?",
      "faq.a3": "Yes, but only for shipping to Illinois addresses through online checkout. Because of compliance restrictions, we cannot sell or ship outside Illinois. For free pickup in Beardstown or Springfield, or for local delivery, please order by text or email. Beardstown delivery is free. Springfield delivery may incur a fee depending on the order and distance. Orders placed with an out-of-state shipping address will be canceled and refunded.",
    ...
    es: {
      ...
      "hero.note": "La recogida gratis está disponible en Beardstown y Springfield. La entrega en Beardstown es gratis. La entrega en Springfield puede tener un costo. Para recogida o entrega local, envíanos un texto o correo para más detalles.",
      "hero.compliance": "El pago en línea es solo para pedidos con envío dentro de Illinois. Para recogida o entrega local, por favor envíanos un texto o correo.",
      "cta.buy": "Pedir envío",
      ...
      "faq.a2": "Usa el pago en línea solo para pedidos con envío dentro de Illinois. Para recogida gratis en Beardstown o Springfield, o para entrega local, ordena directamente por correo o por texto. La entrega en Beardstown es gratis. La entrega en Springfield puede tener un costo según el pedido y la distancia.",
      "faq.q3": "¿Hacen envíos?",
      "faq.a3": "Sí, pero solo para envíos a direcciones dentro de Illinois a través del pago en línea. Por restricciones de cumplimiento, no podemos vender ni enviar fuera del estado. Para recogida gratis en Beardstown o Springfield, o para entrega local, por favor ordena por texto o correo. La entrega en Beardstown es gratis. La entrega en Springfield puede tener un costo según el pedido y la distancia. Los pedidos con una dirección de envío fuera de Illinois serán cancelados y reembolsados.",
